...
def bostontest():
    ...
    yTr = np.loadtxt("./yTr.csv", delimiter=",").reshape(1,-1) #to make it (1,n)

    xTe_secret = np.loadtxt("./xTe_secret.csv", delimiter=",")
    yTe_secret = np.loadtxt("./yTe_secret.csv", delimiter=",").reshape(1,-1) #to make it (1,n)
